...
export const config = {
  ...
  supabaseUrl: process.env.SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://mizueepvtgkmnsyqjxzi.supabase.co',
  ...
  llmMaxTokens: asInt(process.env.LLM_MAX_TOKENS, 2048),
  ragMinSimilarityScore: Number(process.env.RAG_MIN_SIMILARITY_SCORE || 0.60),
