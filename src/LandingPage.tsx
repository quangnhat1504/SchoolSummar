...
export function LandingPage() {
  ...
  return <div className="landing-page">
    ...
    <main id="main-content">
      ...
      <section className="landing-section metrics-section" aria-label="Research workspace proof"><div className="landing-container metrics-intro"><span className="landing-eyebrow">THE RECEIPTS STAY WITH YOU</span><p>From one paper to every follow-up question, the trail stays attached.</p></div><div className="landing-container metrics-grid"><div><span>ONE PAPER</span><strong>∞</strong><p>ways to ask better questions</p></div><div><span>EVERY ANSWER</span><strong>01</strong><p>source trail attached</p></div><div><span>YOUR LIBRARY</span><strong>100%</strong><p>organized around your work</p></div></div></section>
